...
{
    class AsignCursoProfViewModel : ViewModelBase
    {
        MamasApi mamas;
        ...
        public AsignCursoProfViewModel(INavigationService navigationService, IPageDialogService dialogService)
: base(navigationService)
        {
            ...
            insertarAsignCursoProfCommand = new DelegateCommand(InsertarAsignCursoProf);
        }

        void InsertarAsignCursoProf()
        {
            ...
            {
                int idProfesor = Mamas.ViewModels.AdminViewModels.ConfProfesoresViewModel.profesorCompartido;
